  ...
  return (
    <div className="container d-flex justify-content-center">
      <div className="col-md-8">
        <h2 className="text-center text-light">Add New Product</h2>
        <form onSubmit={handleSubmit} className="mt-4 darkyellow px-5 py-5">
          <div className="mb-3">
            <label htmlFor="name" className="form-label fw-2">
              Product Name
            </label>
            <input
              type="text"
          ...
          <div className="mb-3">
            <label htmlFor="description" className="form-label fw-2">
              Description
            </label>
            <textarea
              name="description"
          ...
          <div className="mb-3">
            <label className="form-label fw-2">Gender</label>
          ...
          <div className="mb-3">
            <label className="form-label fw-2">Size</label>
            <div className="d-flex gap-3">
          ...
          <div className="mb-3">
            <label htmlFor="basePrice" className="form-label fw-2">
              Base Price
            </label>
            <input
              type="number"
              name="basePrice"
              id="basePrice"
              className={`form-control ${touched.basePrice && errors.basePrice ? "is-invalid" : ""
                } field-bg`}
          ...
          <div className="mb-3">
            <label htmlFor="stock" className="form-label fw-2">
              Stock
            </label>
            <input
              type="number"
          ...
          <div className="mb-3">
            ...
            <select
              name="discountType"
              id="discountType"
              className={`form-select ${touched.discountType && errors.discountType ? "is-invalid" : ""
                } field-bg`}
          ...
          <div className="mb-3">
            ...
            <input type="file" className="field-bg " name="productImg" onChange={handleFileChange} />
          ...
          <div className="d-flex justify-content-between gap-3">
            <button type="submit" className="btn field-bg w-50">
              Add Product
            </button>
            <button type="button" className="btn field-bg w-50">
              Cancel
            </button>
          </div>
